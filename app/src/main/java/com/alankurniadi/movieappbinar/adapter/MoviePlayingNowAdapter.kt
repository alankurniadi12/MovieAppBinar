...
class MoviePlayingNowAdapter: RecyclerView.Adapter<MoviePlayingNowAdapter.MovieViewHoler>() {
    ...
    inner class MovieViewHoler(itemView: View): RecyclerView.ViewHolder(itemView) {
